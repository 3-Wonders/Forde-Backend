...
import com.project.forde.interceptor.AuthenticationInterceptor;
import com.project.forde.interceptor.PathMatcherInterceptor;
import com.project.forde.interceptor.SessionInterceptor;
import com.project.forde.util.PathMethod;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    private HandlerInterceptor authenticationInterceptor() {
        ...
        return interceptor
                ...
                .includePathPattern("/user/**", PathMethod.GET)
                .includePathPattern("/user/**", PathMethod.PATCH)
                .excludePathPattern("/user/password", PathMethod.PATCH);
    }
